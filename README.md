...
1. Via the `SA_TEST_LOG` environment variable
...
const client = new SaTest({
  logger: logger.child({ name: 'SaTest' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/sachiew/stainless-may-11-2025/issues) with questions, bugs, or suggestions.
