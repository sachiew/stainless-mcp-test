...
import {
  ...
  ExchangeRetrieveVolumeChartParams,
  ExchangeRetrieveVolumeChartResponse,
  Exchanges,
...
import { NFTData, NFTListParams, NFTListResponse, NFTRetrieveByContractParams, NFTs } from './resources/nfts';
import { Ping, PingCheckStatusResponse } from './resources/ping';
import { Search, SearchQueryParams, SearchQueryResponse, SearchTrendingResponse } from './resources/search';
import {
  Simple,
...
import {
  CoinListParams,
  CoinListResponse,
  CoinListWithMarketDataParams,
  CoinListWithMarketDataResponse,
  CoinRetrieveHistoryParams,
  CoinRetrieveHistoryResponse,
  CoinRetrieveOhlcParams,
  CoinRetrieveOhlcResponse,
  CoinRetrieveParams,
  CoinRetrieveTickersParams,
  Coins,
  CoinsDataBase,
  CoinsTickers,
...
export interface ClientOptions {
  /**
   * Defaults to process.env['SA_TEST_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['SA_TEST_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['SA_TEST_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Sa Test API.
 */
export class SaTest {
  apiKey: string | null;
   ...
   * API Client for interfacing with the Sa Test API.
   *
   * @param {string | null | undefined} [opts.apiKey=process.env['SA_TEST_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['SA_TEST_BASE_URL'] ?? https://api.coingecko.com/api/v3] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('SA_TEST_BASE_URL'),
    apiKey = readEnv('SA_TEST_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    ...
    this.timeout = options.timeout ?? SaTest.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SA_TEST_LOG'), "process.env['SA_TEST_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.coingecko.com/api/v3';
  }
  ...
  static SaTestError = Errors.SaTestError;
...
SaTest.Ping = Ping;
SaTest.Simple = Simple;
SaTest.Coins = Coins;
SaTest.AssetPlatforms = AssetPlatforms;
SaTest.Exchanges = Exchanges;
SaTest.Derivatives = Derivatives;
SaTest.NFTs = NFTs;
SaTest.ExchangeRates = ExchangeRates;
SaTest.Search = Search;
SaTest.Global = Global;
SaTest.Companies = Companies;
export declare namespace SaTest {
